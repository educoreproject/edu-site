...
<SectionChrome {chrome} routeKey="resourcesPress" />
		...
		<Container>
			...
			<div class="content-layout">
				<CategorySelector
					...
					groups={filterGroups}
					title="Filters"
					label="Press and charter filters"
				/>
				...
				<div class="document-list">
					...
					{:else}
						<div class="empty-state" role="status">
							...
							<p>
								There are no press or charter documents available{#if activeFilterLabel} for {activeFilterLabel}{/if} yet.
							</p>
						</div>
					{/if}
				</div>

...
<svelte:head>
	...
	<meta
		name="description"
		content={page.hero.description ?? 'DSU standards reference.'}
	/>
</svelte:head>

<SectionChrome {chrome} routeKey="dsuStandards" />

<main>
	<Hero content={page.hero} background="teal" icon="resource" />

	<section class="section section-padded" aria-labelledby="standards-heading">
		<Container>
			<div class="content-layout">
				<CategorySelector
					categories={page.categories}
					label="Standards categories"
